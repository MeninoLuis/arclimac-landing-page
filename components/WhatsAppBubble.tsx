...
export default function WhatsAppBubble() {
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-cta-gradient text-ink shadow-cta"
    >
      <span className="animate-pulseSoft absolute inset-0 rounded-full" />
